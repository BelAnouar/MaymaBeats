...
<head>
    ...
    <link rel="stylesheet" href="/MaymaBeats/public/assets/adminNot.css?v=<?php echo time(); ?>">
    <title>Artiste</title>
</head>
        ...
        <aside id="sidebar">
            <div class="h-100">
                <div class="sidebar-logo">
                    <img src="vecteezy-music-writer-with-feather-and-g-clef-logo-1-658cba5074038115508023-removebg-preview.png" alt="" class="mx-5">
                    <a href="#">MaymaBeats</a>
                </div>
                <!-- Sidebar Navigation -->
