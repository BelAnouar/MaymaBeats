        ...
        <div class="flex flex-col justify-between h-full">
            <div class="flex-grow bg-gray-900 border-r-4 border-[#BC6FF1]">
                <div class="px-4 py-6 text-center border-b">
                    <h1 class="text-xl font-bold leading-none"><span class="text-purple-700">PAR</span><span
                            class="text-white">OLY</span>
                    </h1>
                </div>
                <div class="p-4">
                    <ul class="space-y-1">
                        <li>
                            <a href="#plan"
                                class="flex text-white rounded-xl font-bold text-sm hover:text-purple-900 hover:bg-white py-3 px-4 transition ease-in-out delay-150">
                        ...
                        <li>
                            <a href="#projet"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    class="text-lg mr-4" viewBox="0 0 16 16" fill="currentColor">
                                    <path
            ...
            <div class="bg-gray-900 border-r-4 border-[#BC6FF1] p-4 flex flex-col">
                <button type="button"
                    class="inline-flex items-center justify-center h-9 px-4 my-5 rounded-xl bg-white text-purple-700 hover:text-white hover:bg-purple-700 text-sm font-semibold transition">
                ...
                <button type="button"
                    class="inline-flex items-center justify-center h-9 px-4 rounded-xl bg-white text-purple-700 hover:text-white hover:bg-purple-700 text-sm font-semibold transition">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class=""
                        viewBox="0 0 16 16">
                        <path
                            d="M12 1a1 1 0 0 1 1 1v13h1.5a.5.5 0 0 1 0 1h-13a.5.5 0 0 1 0-1H3V2a1 1 0 0 1 1-1h8zm-2 9a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" />
